// ============================================================
// BOTTOM NAV — Navegação inferior mobile-first (5 abas)
// ============================================================
import { useLocation } from "wouter";
import { Home, CalendarDays, TrendingDown, Utensils, BarChart2 } from "lucide-react";
import { cn } from "@/lib/utils";

interface BottomNavProps {
  active: "home" | "plano" | "peso" | "nutricao" | "report";
}
...
export default function BottomNav({ active }: BottomNavProps) {
  ...
  const items = [
    ...
    { id: "report" as const,   label: "Relatório", icon: BarChart2,   path: "/relatorio" },
  ];
